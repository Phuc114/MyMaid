...
TRUNCATE TABLE danh_gia, lich_dat, dich_vu_yeu_thich, dia_chi_da_luu, khach_hang, thanh_toan, khuyen_mai, lich_lam_viec, khu_vuc_hoat_dong, khu_vuc, maid, dich_vu, danh_muc_dich_vu RESTART IDENTITY CASCADE;
